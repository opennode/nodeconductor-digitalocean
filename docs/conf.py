...
from waldur_digitalocean import __version__
...
htmlhelp_basename = 'waldur-digitaloceandoc'
...
latex_documents = [
  ('index', 'waldur-digitalocean.tex', u'Waldur DigitalOcean Documentation',
   u'OpenNode', 'manual'),
]
