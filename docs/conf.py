...
project = u'NodeConductor DigitalOcean'
...
from nodeconductor_digitalocean import __version__
...
htmlhelp_basename = 'nodeconductor-digitaloceandoc'
...
latex_documents = [
  ('index', 'nodeconductor-digitalocean.tex', u'NodeConductor DigitalOcean Documentation',
   u'OpenNode', 'manual'),
]
...
man_pages = [
    ('index', 'nodeconductor-digitalocean', u'NodeConductor DigitalOcean Documentation',
     [u'OpenNode'], 1)
]
...
texinfo_documents = [
  ('index', 'NodeConductor DigitalOcean', u'NodeConductor DigitalOcean Documentation',
   u'OpenNode', 'nodeconductor-digitalocean', 'One line description of project.',
   'Miscellaneous'),
]
...
Command().handle('nodeconductor_digitalocean', path='docs/drfapi')
